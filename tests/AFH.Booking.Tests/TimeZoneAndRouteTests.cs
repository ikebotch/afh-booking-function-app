...
public class TimeZoneAndRouteTests
{
    ...
    [InlineData("Bookings_PartnerCancel", EndpointAccessPolicy.UserAuthenticated)]
    [InlineData("Bookings_PartnerRearrange", EndpointAccessPolicy.UserAuthenticated)]
    [InlineData("Bookings_PartnerRearrangementOptions", EndpointAccessPolicy.UserAuthenticated)]
    ...
    [InlineData("Bookings_PartnerCancel", BookingPermissionNames.CancelAsPartner)]
    [InlineData("Bookings_PartnerRearrange", BookingPermissionNames.RearrangeAsPartner)]
