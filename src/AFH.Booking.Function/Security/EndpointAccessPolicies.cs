...
public static class EndpointAccessPolicies
{
    private static readonly IReadOnlyDictionary<string, EndpointAccessPolicy> Policies =
        new Dictionary<string, EndpointAccessPolicy>(StringComparer.Ordinal)
        {
            ...
            ["Notifications_Requests_MarkFailed"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Requests_Requeue"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Activate"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Create"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Deactivate"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Get"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_GetByKey"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_List"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Preview"] = EndpointAccessPolicy.InternalOnly,
            ["Notifications_Templates_Update"] = EndpointAccessPolicy.InternalOnly,
