...
public sealed class BookingNotificationRuleRecipientModelConfiguration : IEntityTypeConfiguration<BookingNotificationRuleRecipientModel>
{
    ...
    private static IReadOnlyList<BookingNotificationRuleRecipientModel> CreateSeeds()
    {
        ...
        Add(rows, "BookingConfirmed", enabled: true, now, "f3096f1b-fd20-4cc3-a431-22f1d1021d01", "12d8a812-96fc-4020-93cd-30a82efa3c02", "f7726ed6-0939-49d3-b18c-5f2e34959f03");
        Add(rows, "BookingRescheduled", enabled: true, now, "982657c1-2041-4fed-9cb1-5a802e258704", "42cda070-c4cd-4fdb-ab79-c3d6870baf7e", "55f92361-2f74-4128-a794-703eff8ca9e3");
        Add(rows, "BookingCancelled", enabled: true, now, "a689b522-d031-44db-b145-e8109350c271", "566301d9-a5d6-4e2d-a688-65b6d11c00f2", "27650cba-e5cf-4777-903d-24123832d1a3");
        Add(rows, "BookingHoldCreated", enabled: false, now, "9c987676-c344-476a-a57a-8a22e2d97922", "6bc808c6-53a3-473f-972d-d8871678e4d4", "84186f63-a40d-419b-933d-573106880aeb");
        return rows;
    }
