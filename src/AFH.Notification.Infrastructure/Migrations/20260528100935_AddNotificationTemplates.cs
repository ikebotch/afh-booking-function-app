    ...
    public partial class AddNotificationTemplates : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("10000000-0000-0000-0000-000000000001"), "Hello,\n\nYour booking is now confirmed.\n\nTransaction reference: {{transactionRef}}\nBooking ID: {{bookingId}}\nAdviser: {{adviserName}}\nMeeting type: {{meetingType}}\nWhen: {{when}}\n{{whereLine}}\n\n{{travelLine}}\n{{manageBookingLinks}}\n\nThis is an automated AFH booking notification.", "Email", "text/plain", "System", new DateTime(2026, 5, 28, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Booking confirmed", "AFH Booking: Booking Confirmed", "booking-confirmed", "v1", "System", new DateTime(2026, 5, 28, 0, 0, 0, 0, DateTimeKind.Utc) },
