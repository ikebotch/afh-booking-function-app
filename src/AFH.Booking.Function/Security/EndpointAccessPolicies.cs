...
public static class EndpointAccessPolicies
{
    private static readonly IReadOnlyDictionary<string, EndpointAccessRequirement> Requirements =
        new Dictionary<string, EndpointAccessRequirement>(StringComparer.Ordinal)
        {
            ...
            ["Approvals_List"] = UserPermissionAny(BookingPermissionNames.ApprovalsRead, BookingPermissionNames.ApprovalRequestsReadOwn),
            ["Approvals_ListPending"] = UserPermissionAny(BookingPermissionNames.ApprovalsRead, BookingPermissionNames.ApprovalRequestsReadOwn),
