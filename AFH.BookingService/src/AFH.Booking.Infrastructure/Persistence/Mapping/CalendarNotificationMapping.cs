...
//internal static class CalendarNotificationMapping
//{
//    // ---------------------------
//    // Model -> Domain
//    // ---------------------------
//    public static CalendarNotificationReceipt ToDomain(this CalendarNotificationReceiptModel m, bool includeSlots = false)
//    {
//        return CalendarNotificationReceipt.Rehydrate(
//      id: m.Id,
...
//        if (includeSlots)
//        {
//            m.Slots = tx.Slots.Select(s => s.ToModel()).ToList(); // you’ll define slot mapping
//        }
...
//        // Slots are usually managed separately (add/remove in Slot repository),
//        // so we do NOT overwrite m.Slots here.
//    }
//}